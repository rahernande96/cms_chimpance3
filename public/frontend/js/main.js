...
(function($) {
  ...
  $(document).ready(function() {
    ...
    // eventos
    // var roundedbookingform = $('.popup-booking-event')
    // var roundedbookingformtoggle = $('.booking-event-toggle')
    // roundedbookingformtoggle.on('click', function() {
    //   roundedbookingform.toggleClass('open');
    //   $(this).toggleClass('open');
    // });
    ...
    $("#booking-form").on('submit', function(e) {
      ...
      var booking_startdate = $("input[name=booking-date]").val();
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = -31.980469; // Google Map Latitude
      var var_longitude = -64.558750; // Google Map Longitude
      var pin = 'images/icons/pin.svg';

      //Map pin-window details
      var title = "Panacea Hotel Boutique";
      var hotel_name = "Panacea";
      var hotel_address = "Islas Malvinas 151, Villa General Belgrano, Córdoba";
      var hotel_desc = "Hotel Boutique";
      var hotel_more_desc = "Panacea Hotel un lugar de placer y buen gusto";
